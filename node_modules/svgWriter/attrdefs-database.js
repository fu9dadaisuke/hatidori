...
module.exports = {
    ...
    "*": {
        ...
        "font-size": [0, "number"], // font-size could be string in CSS but AGC doesn't accept strings.
        ...
        "kerning": ["auto", "string"],
        "letter-spacing": [0, "number"], // letter-spacing could be string in CSS but AGC doesn't accept strings.
