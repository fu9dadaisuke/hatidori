...
(function () {
    ...
    var self = {
        ...
        writeGradient: function (ctx, styleBlock, gradientRef, flavor) {
            var gradient = ctx.svgOM.resources.gradients[gradientRef.ref];
            if (!gradient) {
                ctx.errors.push("Gradient " + gradientRef.ref + " is missing.");
                return;
            }
            ...
            ctx.omStylesheet.def(tag, function (def) {
                styleBlock.addRule(flavor, "url(#" + ctx.prefix + def.getAttribute("id") + ")");
            }, fingerprint);
        }
    };
