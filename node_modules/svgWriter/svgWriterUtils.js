...
(function () {
    ...
    function SVGWriterUtils() {
        ...
        function writeColorMaker(noOpacity) {
            return function (val, ctx) {
                ...
                if (typeof val == "object") {
                    ...
                    var rgb = val.value || val;
                    if (!noOpacity && isFinite(val.alpha) && !ctx.eq(val.alpha, 1)) {
        ...
        self.writeColor = writeColorMaker();
        self.writeColorNoOpacity = writeColorMaker(true);
        ...
        self.hasGlobalFx = function (ctx) {
            // Take the global state from the first applied filter.
            return ctx.currentOMNode.style && ctx.currentOMNode.style.filters && ctx.currentOMNode.style.filters.length && ctx.currentOMNode.style.filters[0].global;
        };
    }
